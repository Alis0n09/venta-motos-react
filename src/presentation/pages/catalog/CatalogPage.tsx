...
import {
  Search, Add, TwoWheeler, FilterList, FavoriteBorder,
    ...
    >
      <Box sx={{ position: 'relative', bgcolor: colors.border, height: 200 }}>
        ...
        <IconButton
          ...
          <FavoriteBorder sx={{ fontSize: 18, color: colors.accent }} />
        </IconButton>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 4, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <FormControl sx={{ minWidth: 130 }}>
            <Select
              ...
              displayEmpty
              renderValue={(v) => v ? marcas.find(m => String(m.id) === v)?.nombre : 'Marca'}
            >
          ...
          <FormControl sx={{ minWidth: 130 }}>
            <Select
              ...
              displayEmpty
              renderValue={(v) => v ? categorias.find(c => String(c.id) === v)?.nombre : 'Tipo'}
            >
          ...
          <FormControl sx={{ minWidth: 130 }}>
            <Select
              ...
              displayEmpty
              renderValue={(v) => v === 'asc' ? 'Menor precio' : v === 'desc' ? 'Mayor precio' : 'Precio'}
            >
          ...
          <FormControl sx={{ minWidth: 150 }}>
            <Select
              ...
              displayEmpty
              renderValue={(v) => v === 'disponible' ? 'Disponible' : v === 'reservada' ? 'Reservada' : v === 'vendida' ? 'Vendida' : 'Disponibilidad'}
            >
